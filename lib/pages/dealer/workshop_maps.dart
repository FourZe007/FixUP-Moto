...
class WorkshopMaps extends StatefulWidget {
  WorkshopMaps(this.latitudeIndex, this.longitudeIndex, {super.key});
        ...
        body: Stack(
          children: [
            FlutterMap(
              options: MapOptions(
                center: LatLng(
                  GlobalVar.latitudeList[widget.latitudeIndex],
                  GlobalVar.longitutdeList[widget.longitudeIndex],
                ),
                zoom: 15.0,
              ),
              children: [
